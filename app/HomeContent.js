    ...
    <>
        ...
        <div className={styles.herocentre}>
          ...
          <div className={styles.herotimings}>
            ...
            >
              ...
              >
                7/79 Williamson Road, Ingleburn, NSW 2565{" "}
                <OpenInNewRounded className={styles.externalIcon} />
              </a>
            </motion.div>
          </div>
          <motion.button
      ...
      <div ref={aboutRef} tabIndex={-1} className={styles.aboutcontainer}>
        ...
        <p className={styles.abouttext}>
          ...
          mission is to guide people to the Lord Jesus Christ, who is the only
          way to the Father. We want to be a place where individuals and
